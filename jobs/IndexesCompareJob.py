...
class IndexesCompareJob(p.PostSectionGenerator):
    def __init__(self, index_closes_file_path, index_names_files_path, blog_upload_relative_path, blog_upload_absolute_path):
        self.index_closes_file_path = index_closes_file_path
        self.index_names_files_path = index_names_files_path
    ...
    def generate(self, blog_generator):
        ...
        df_names = pd.read_csv(
            index_names_files_path
            header=True,
            infer_datetime_format=True)

        df_closes = pd.read_csv(
            index_closes_file_path,
