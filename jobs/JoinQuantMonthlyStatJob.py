...
class JoinQuantMonthlyStatJob(j.JoinQuantJobBase, b.BlogPostGenerateJobBase):
    ...
    def run(self):
        ...
        blog_generator = HexoGenerator.HexoGenerator(self.post_path, '主要指数月回报统计'.format(today_str), tags=['数据统计'])
