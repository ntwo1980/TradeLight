...
class JoinQuantWeekdaylyStatJob(j.JoinQuantJobBase, b.BlogPostGenerateJobBase):
    ...
    def run(self):
        ...
        blog_generator = HexoGenerator.HexoGenerator(self.post_path, '主要指数周内回报统计'.format(today_str), tags=['数据统计'])
