...
class StocksStatJob(j.JobBase):
    ...
    def generate_post(self, df):
        ...
        df.loc[:,'code'] = df['code'].map(lambda x: blog_generator.get_url_str(x, '/stocks/?code=' + x) + blog_generator.get_raw_str('<li class="fa fa-fw fa-star-o" style="color:orange"></li>'))
